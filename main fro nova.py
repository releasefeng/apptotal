...
class FourScreen(Screen):
    ...
    def btn_pressed(self, instance, pos):
        ...
        if int(pos[0])<=480 and int(pos[0]) >=280 and int(pos[1])>=270 and int(pos[1]) <=490:
            self.speedadd()
        elif int(pos[0])<=770 and int(pos[0]) >=580 and int(pos[1])>=270 and int(pos[1]) <=490:
            self.speedsub()
        else:
    ...
    def getPostion(self):
        ...
        posx=int(poslist[0])
        posy=int(poslist[1])
        if posx <=910 and posx >=210 and posy<=1985 and posy >=1185:
            repostion=1
        else:
            pass
    ...
    def getdirinfo(self,posx,posy):
        if posx>=510 and posx<=910 and posy>=1505 and posy<=1665:
            distance='front'
            if posx>=510 and posx<=610:
                navi='lev1'
            else:
                navi='lev2'
        elif posx>=510 and posx<=910 and posy>1665 and posy<=1825:
            distance='left'
            navi='lev1'
        elif posx>=510 and posx<=910 and posy>1825 and posy<=1985:
            distance='left'
            navi='lev2'
        elif posx>=510 and posx<=910 and posy>=1345 and posy<1505:
            distance='right'
            navi='lev1'
        elif posx>=510 and posx<=910 and posy>=1185 and posy<1345:
            distance='right'
            navi='lev2'
        elif posx<510 and posx>=210 and posy>=1505 and posy<=1665:
            distance='back'
            if posx<510 and posx>=410:
                navi='lev1'
            else:
                navi='lev2'
        elif posx<510 and posx>=210 and posy>1665 and posy<=1985:
            distance='backleft'
            navi='None'
        elif posx<510 and posx>=210 and posy>=1185 and posy<1505:
            distance='backright'
            navi='None'
        else:
            distance='None'
